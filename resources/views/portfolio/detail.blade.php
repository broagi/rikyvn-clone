...
@section('content')
    <div class="popup-detail">
      ...
      <div class="banner-detail">
        <img src="{{Storage::url($portifolio->image1)}}" atl="" />
      </div>
      <div class="content-detail" style="background-image: linear-gradient(to right, <?php echo $portifolio->color1 ?> , <?php echo $portifolio->color2 ?>);">
        <div class="container">
          <div class="link-web">
          ...
          <div class="desktop-detail">
            <img src="{{Storage::url($portifolio->image2)}}" atl="" />
          </div>
          <div class="mobile-detail">
            <img src="{{Storage::url($portifolio->image3)}}" atl="" />
          </div>
        </div>
      </div>
    </div>
