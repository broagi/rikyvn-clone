                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Thumbnail
                                    (Max: 5Mb)</label>
                                @if ($portifolio->thumbnail)
                                  <img width="400" height="300" src={{Storage::url($portifolio->thumbnail)}}></img>
                                  @endif
                                <div
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Banner
                                    (Max: 5Mb)</label>
                                    @if ($portifolio->image1)
                                  <img width="400" height="300" src={{Storage::url($portifolio->image1)}}></img>
                                  @endif
                                <div
                                    class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                    <div class="text-center">
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Desktop
                                    (Max: 5Mb)</label>
                                    @if ($portifolio->image2)
                                  <img width="400" height="300" src={{Storage::url($portifolio->image2)}}></img>
                                  @endif
                                <div
                                    class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                    <div class="text-center">
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900">Mobile
                                    (Max: 5Mb)</label>
                                    @if ($portifolio->image3)
                                  <img width="400" height="300" src={{Storage::url($portifolio->image3)}}></img>
                                  @endif
                                <div
                                    class="mt-2 flex justify-center rounded-lg border border-dashed border-gray-900/25 px-6 py-10">
                                    <div class="text-center">
                            ...
                            <div>
                                ...
                                <div>
                                    <input name="title" required value="{{$portifolio->title}}"
                            ...
                            <div>
                                ...
                                <div>
                                    <input name="link" value="{{$portifolio->link}}"
                                        class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    @error('link')
                            ...
                            <div>
                                ...
                                <div class="inline-flex space-x-5">
                                    <div>
                                    <input name="color1" value="{{$portifolio->color1}}" placeholder="black"
                                ...
                                <div>
                                    <input name="color2" value="{{$portifolio->color2}}" placeholder="white"
                                        class="block rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" />
                                    @error('color2')
                            ...
                            <div>
                                ...
                                <div>
                                    <input name="ordering" type="number" value="{{$portifolio->ordering}}"
