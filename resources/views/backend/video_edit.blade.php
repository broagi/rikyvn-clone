                        ...
                        <div class="border-b border-gray-900/10 pb-12">
                            ...
                            <div class="col-span-full">
                                <label for="cover-photo"
                                    class="block text-sm font-medium leading-6 text-gray-900">Video</label>
                                    @if ($video->path)
                                    <video width="400" height="300" src={{url($video->path)}} controls autoplay></video>
                                    @endif
                                <div
                                    ...
                                    <div class="text-center">
                                        ...
                                        <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                            <label for="file-upload"
                                                ...
                                                <input accept="video/*" id="file-upload" name="attachment"
                                  ...
                                  <div class="text-center">
                                      ...
                                      <div class="mt-4 flex text-sm leading-6 text-gray-600">
                                          <label for="cover-upload"
                                              class="relative cursor-pointer rounded-md bg-white font-semibold text-indigo-600 focus-within:outline-none focus-within:ring-2 focus-within:ring-indigo-600 focus-within:ring-offset-2 hover:text-indigo-500">
                                              <span>Upload a file</span>
                                              <input accept="image/*" id="cover-upload" name="cover"
                                                  type="file" class="sr-only">
                                          </label>
                                          <p class="pl-1">or drag and drop</p>
                                      </div>
