...
function onScroll() {
    ...
    let id = ['#videos','#hinhanh','#sumenh','#gioithieu', '#chuyengia', '#dangky'].find((e) => $(e).visible(false));
    if (!id) {
      id = ['#videos','#hinhanh','#sumenh','#gioithieu', '#chuyengia', '#dangky'].reverse().find((e) => $(e).visible(true));
    }
    if (id) {
...
$(document).ready(function () {
    ...
    $(".popup-album-photo .slider-nav").slick({
        slidesToShow: 8,
        slidesToScroll: 1,
        asNavFor: ".popup-album-photo .slider-for",
        centerMode: true,
        focusOnSelect: true,
        variableWidth: true,
        infinite: true
